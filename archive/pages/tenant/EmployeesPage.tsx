...
import { Plus, Edit, Users, Mail, Phone, Briefcase, UserX, UserCheck } from 'lucide-react';
      ...
      {employees.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">{t('employee.noEmployeesYet')}</h3>
            <p className="text-gray-600 mb-6">{t('employee.startBuildingTeam')}</p>
