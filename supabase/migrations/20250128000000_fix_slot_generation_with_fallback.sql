-- Fix slot generation to work without explicit employee assignments
...
-- Add comment
COMMENT ON FUNCTION generate_slots_for_shift IS 'Generates time slots for a shift with fallback logic: 1) shift employees, 2) service employees, 3) all tenant employees';
