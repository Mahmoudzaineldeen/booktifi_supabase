-- Include package purchase spend in visitors_db_verification total_spent.
-- Total spent = booking paid amounts + package purchase amounts (all customer spending).
...
BEGIN
  ...
  -- Q6: Total spent = booking paid amounts + package purchase amounts
  SELECT (
...
COMMENT ON FUNCTION visitors_db_verification(uuid) IS
  'Debug: returns DB-level visitor stats (Q1–Q6). total_spent = booking paid + package purchases.';
