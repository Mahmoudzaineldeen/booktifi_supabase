/*
  ...
  - Helper functions with proper permissions
*/
...
CREATE TABLE zoho_invoice_logs (
  id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
  tenant_id uuid REFERENCES tenants(id) ON DELETE CASCADE NOT NULL,
  booking_id uuid REFERENCES bookings(id) ON DELETE SET NULL,
  invoice_id text,
...
CREATE INDEX idx_services_is_public ON services(is_public) WHERE is_public = true;
...
CREATE INDEX idx_service_offers_tenant_id ON service_offers(tenant_id);
CREATE INDEX idx_service_offers_dates ON service_offers(start_date, end_date);
...
CREATE INDEX idx_employee_services_shift_id ON employee_services(shift_id);
CREATE INDEX idx_employee_services_tenant_id ON employee_services(tenant_id);
CREATE INDEX idx_slots_tenant_id ON slots(tenant_id);
CREATE INDEX idx_slots_service_id ON slots(service_id);
CREATE INDEX idx_slots_shift_id ON slots(shift_id);
CREATE INDEX idx_slots_employee_id ON slots(employee_id) WHERE employee_id IS NOT NULL;
CREATE INDEX idx_slots_slot_date ON slots(slot_date);
CREATE INDEX idx_slots_start_time_utc ON slots(start_time_utc);
CREATE INDEX idx_slots_available ON slots(is_available) WHERE is_available = true;
CREATE INDEX idx_slots_date_service ON slots(slot_date, service_id, is_available);
CREATE INDEX idx_customers_tenant_id ON customers(tenant_id);
CREATE INDEX idx_customers_phone ON customers(tenant_id, phone);
CREATE INDEX idx_bookings_tenant_id ON bookings(tenant_id);
CREATE INDEX idx_bookings_service_id ON bookings(service_id);
CREATE INDEX idx_bookings_slot_id ON bookings(slot_id);
CREATE INDEX idx_bookings_employee_id ON bookings(employee_id) WHERE employee_id IS NOT NULL;
...
CREATE INDEX idx_reviews_service_id ON reviews(service_id) WHERE service_id IS NOT NULL;
...
CREATE INDEX idx_service_packages_is_public ON service_packages(is_public) WHERE is_public = true;
...
CREATE INDEX idx_package_subscriptions_tenant_id ON package_subscriptions(tenant_id);
CREATE INDEX idx_package_subscriptions_customer_id ON package_subscriptions(customer_id);
CREATE INDEX idx_package_subscriptions_package_id ON package_subscriptions(package_id);
CREATE INDEX idx_package_subscriptions_is_active ON package_subscriptions(is_active) WHERE is_active = true;
CREATE INDEX idx_package_usage_subscription_id ON package_usage(subscription_id);
CREATE INDEX idx_package_usage_booking_id ON package_usage(booking_id);
...
CREATE INDEX idx_testimonials_is_active ON testimonials(is_active) WHERE is_active = true;
CREATE INDEX idx_testimonials_display_order ON testimonials(display_order);
CREATE INDEX idx_zoho_tokens_tenant_id ON zoho_tokens(tenant_id);
CREATE INDEX idx_zoho_invoice_logs_tenant_id ON zoho_invoice_logs(tenant_id);
CREATE INDEX idx_zoho_invoice_logs_booking_id ON zoho_invoice_logs(booking_id) WHERE booking_id IS NOT NULL;
CREATE INDEX idx_tenant_zoho_configs_tenant_id ON tenant_zoho_configs(tenant_id);
CREATE INDEX idx_payments_booking_id ON payments(booking_id);
CREATE INDEX idx_payments_tenant_id ON payments(tenant_id);
CREATE INDEX idx_otp_requests_phone ON otp_requests(phone) WHERE phone IS NOT NULL;
CREATE INDEX idx_otp_requests_email ON otp_requests(email) WHERE email IS NOT NULL;
