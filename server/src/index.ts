...
import { daftraRoutes } from './routes/daftra';
...
import { landingBuilderRoutes } from './routes/landingBuilder';
...
app.use('/api/daftra', daftraRoutes);
...
app.use('/api/landing-builder', landingBuilderRoutes);
